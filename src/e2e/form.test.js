...
describe('Card number validation', () => {
  ...
  test('if card is Visa it should able Visa logo', async () => {
    ...
    const visaClass = await page.evaluate((el) => el.className, visa);
  ...
  test('if card is Mir it should able Mir logo', async () => {
    ...
    const mirClass = await page.evaluate((el) => el.className, mir);
  ...
  test('if card is JCB it should able JCB logo', async () => {
    ...
    const jcbClass = await page.evaluate((el) => el.className, jcb);
